            ...
            <div class="{card_class}">
                ...
                <div class="card-body p-3">
                    <div class="form-group mb-4">
                        <label for="contact_us_section_title" class="form-label required">Contact Us Section
                            Title</label>
                        <input value="<?= ES('contact_us_section_title','For any query, feel free to contact-') ?>" required name="contact_us_section_title"
                            id="contact_us_section_title" placeholder="Enter Contact Us Section Title"
                            class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label for="email" class="form-label required">Enter Email</label>
                        <input value="<?= ES('email') ?>" type="email" required name="email" id="email"
                            placeholder="Enter Email" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label for="number" class="form-label required">Enter Mobile</label>
                        <input value="<?= ES('number') ?>" type="text" required name="number" id="number"
                            placeholder="Enter Mobile" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label for="address" class="form-label required">Enter Address</label>
                        <textarea name="address" id="address" class="form-control"
                            placeholder="Enter Address"><?= ES('address') ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label for="map" class="form-label required">Enter Map</label>
                        <textarea name="google_map_url" id=""
                            class="form-control"><?= ES('google_map_url') ?></textarea>
                    </div>
                </div>
