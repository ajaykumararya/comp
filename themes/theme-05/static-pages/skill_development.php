    ...
    <div class="col-md-6">
        ...
        <div class="{card_class}">
            <div class="card-header">
                <h3 class="card-title">Add Section Item</h3>
            </div>
            <div class="card-body">
                <?php
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="<?= $type ?>_title" class="form-control"
                            value="<?= ES("{$type}_title", 'Title') ?>" placeholder="Enter Title">
                    </div>
                    <div class="form-group">
                        <label for="title" class="form-label">Section Title</label>
                        <textarea type="text" name="<?= $type ?>_description" class="form-control"
                            placeholder="Enter Description"><?= ES("{$type}_description", 'Description') ?></textarea>
                    </div>
                </div>
                <div class="card-footer">
                    {save_button}
