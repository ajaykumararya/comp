...
var statNotUpdating = !0;
function getAbsoluteHeight(e) {
...
window.onscroll = function () {
  ...
  var e = document.getElementById("counter"),
    t = e.offsetTop,
    n = getAbsoluteHeight(e),
    r = 2 * window.innerHeight;
  if (window.pageYOffset > t + n - r && statNotUpdating) {
    statNotUpdating = !1;
    var o = document.querySelectorAll(".counter-value");
    for (let a of o) {
      function l() {
        var e = +a.getAttribute("data-target"),
          t = +a.getAttribute("data-speed"),
          n = +a.innerText,
          r = e / t;
        n < e
          ? ((a.innerText = Math.ceil(n + r)), setTimeout(l, 1))
          : (a.innerText = e);
      }
      l();
    }
...
const images = document.querySelectorAll("[data-src]"),
  config = { rootMargin: "0px 0px 50px 0px", threshold: 0 };
let loaded = 0,
...
function scrollNXR(e, t) {
  ...
  l.appendChild(a),
    e.appendChild(l),
    (n.style.cssText =
      "margin-top: -" + o + "px; transition : all " + t + "s;"),
    setTimeout(() => {
      n.remove(), scrollNXR(e, t);
    }, 1e3 * t + 500);
}
images.forEach((e) => {
  observer.observe(e);
}),
  new bootstrap.Toast(document.getElementById("cookieToast"), {
    autohide: !1,
  }).show(),
  scrollNXR(document.querySelector("#news-container"), 2.5);
const card = document.querySelector(".card-3d"),
  motionMatchMedia = window.matchMedia("(prefers-reduced-motion)"),
  THRESHOLD = 15;
function handleHover(e) {
  const { clientX: t, clientY: n, currentTarget: r } = e,
    { clientWidth: o, clientHeight: l, offsetLeft: a, offsetTop: i } = r,
    s = (n - i) / l,
    d = (7.5 - 15 * ((t - a) / o)).toFixed(2),
    c = (15 * s - 7.5).toFixed(2);
  card.style.transform = `perspective(${o}px) rotateX(${c}deg) rotateY(${d}deg) scale3d(1, 1, 1)`;
}
function resetStyles(e) {
  card.style.transform = `perspective(${e.currentTarget.clientWidth}px) rotateX(0deg) rotateY(0deg)`;
}
function sliderAuto(e, t) {
  const n = e.track.childElementCount;
  let r = null,
    o = 1;
  function l() {
    r = setTimeout(function () {
      o >= n && (o = 0), e.scrollItem(o++);
    }, t);
  }
  e.ele.addEventListener("glider-animated", function () {
    window.clearInterval(r), l();
  }),
    l();
}
motionMatchMedia.matches ||
  ...
  (recentCentersGlider = new Glider(document.querySelector("#recentCenters"), {
    slidesToShow: 3,
    slidesToScroll: 1,
    scrollLock: !0,
    draggable: !0,
    ...
    responsive: [
      ...
      {
        breakpoint: 1024,
        settings: { slidesToShow: 6, slidesToScroll: "auto" },
      },
    ],
  })),
  (testimonialsGlider = new Glider(document.querySelector("#testimonials"), {
    slidesToShow: 1,
    slidesToScroll: 1,
    scrollLock: !0,
    draggable: !0,
  ...
  // console.log(testimonialsGlider);
  sliderAuto(recentCentersGlider, 2e3),
  sliderAuto(testimonialsGlider, 2e3);
