        ...
        <div class="{card_class}">
            ...
            <div class="card-body row">
                ...
                <div class="form-group mb-4 col-md-12">
                    ...
                    <input type="text" class="form-control selectdate" required name="field4">
                </div>

                <div class="form-group mb-4 col-md-12">
                    <label for="" class="form-label required" required>Redirect Link</label>
                    <textarea type="text" required name="field5" class="form-control"
...
<div class="row">
    <div class="col-md-12 mt-5">
        <div class="{card_class}">
            <div class="card-header">
                <h3 class="card-title">List News & Event(s)</h3>
            </div>
            <div class="card-body">
