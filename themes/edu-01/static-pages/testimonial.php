    ...
    <div class="col-md-8">
        ...
        <div class="{card_class}">
            ...
            <div class="card-body row">
                ...
                <div class="form-group mb-4 col-md-6">
                    <label for="" class="form-label required" required>City</label>
                    <input type="text" required name="field4" class="form-control" placeholder="Enter City">
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group mb-4">
                        ...
                        <input class="form-control" name="<?= $type ?>_title"
                            value="<?= ES($type . '_title', 'Alumini Testimonials') ?>">
                    </div>
                </div>
                <div class="card-footer">
                    {save_button}
...
<div class="row">
    <div class="col-md-12 mt-5">
        <div class="{card_class}">
            <div class="card-header">
                <h3 class="card-title">List Testiminial(s)</h3>
            </div>
            <div class="card-body">
