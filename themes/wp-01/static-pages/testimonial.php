        ...
        <div class="card">
            ...
            <div class="card-body row">
                ...
                <div class="form-group mb-4 col-md-12">
                    ...
                    <textarea required name="field3" maxlength="300" class="form-control" placeholder="Enter Description"></textarea>
                </div>
                <div class="form-group mb-4 col-md-6">
                    <label for="" class="form-label required">Name</label>
                    <input type="text" name="field4" class="form-control" placeholder="Name" required>
                </div>
                            ...
                            if ($data->num_rows()):
                                ...
                                foreach ($data->result() as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $this->ki_theme->parse_string($row->field4) ?>
                                        </td>
                                        <td>
