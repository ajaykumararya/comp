                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                    ...
                                    <div class="image-input-wrapper w-150px h-150px" style="background-size:100% 100%">
                                    </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--begin::Button-->
                                <a href="{base_url}static-page/blog-category"
                                ...
                                <!--begin::Input-->
                                <input name="field6" placeholder="Author Name" class="form-control mb-2" value=""
                                    required />
                                <!--end::Input-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="field8" class="form-control selectdate"
                                        placeholder="Select Publish Date" required value="<?= date('d-m-Y') ?>">
                                </div>
                            </div>
                            <!--end::Card header-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" name="field2" class="form-control mb-2"
                                                    placeholder="Blog Title" value="" required="" id="title" />
                                                <input type="hidden" name="field7" id="slug">
                                                <label class="text-warning" id="slugPreview"></label>
                                                <!--end::Input-->

                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">A Blog Title is required and recommended to
                                                    be
                                                    unique.
                                                </div>
                                                <!--end::Description-->
                                            ...
                                            <div>
                                                ...
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">Set a description to the Blog for better
                                                    visibility.
                                                </div>
                                                <!--end::Description-->
                                            </div>
                            ...
                            if ($data->num_rows()):
                                ...
                                foreach ($data->result() as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $row->field2 ?>
                                            <a href="{base_url}blog/<?= $row->field7 ?>" target="_blank"><i
                                                    class="fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                            <?= date('d M, Y', strtotime($row->field8)) ?>
                                        </td>
                                        <td>
