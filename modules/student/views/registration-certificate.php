        ...
        <form id="admit_card_form">
            <div class="{card_class}">
                <div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse"
                    ...
                    <h3 class="card-title">Create Registration Certificate</h3>
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    <div class="card-body">
                        <div class="row">
                            ...
                            ?>
                            <div class="form-group mb-4 col-md-6 col-xs-12 col-sm-12 <?=$boxClass?>">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="examination_body" required placeholder="Examination Body.."  id="" class="form-control"></textarea>
                            </div>
                        </div>
    ...
    <div class="col-md-12 mt-10">
        <div class="{card_class}">
            <div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#list">
                <h3 class="card-title">List Registration Certificate(s)</h3>
                <div class="card-toolbar rotate-180">
                    <i class="ki-duotone ki-down fs-1"></i>
                </div>
            </div>
