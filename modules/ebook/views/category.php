        ...
        <form id="add_course_category">
            <div class="{card_class}">
                <div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse"
                    ...
                    <h3 class="card-title">Add EBook Category</h3>
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" class="form-control" placeholder="Enter Title">
    ...
    <div class="col-md-7">
        <div class="{card_class}">
            <div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#list">
                <h3 class="card-title">List EBook Category(s)</h3>
                <div class="card-toolbar rotate-180">
                    <i class="ki-duotone ki-down fs-1"></i>
                </div>
            </div>
...
<script id="formTemplate" type="text/x-handlebars-template">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="category_name" placeholder="enter Name" value="{{category_name}}">        
