    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="text-center animation animated fadeInUp" data-aos="fade-up" data-animation="fadeInUp"
                    ...
                    <div class="heading_s1 text-center">
                        <h2 class="main-heading center-heading"><i class="fa fa-list-alt"></i> Examination Form</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 mb-4 mt-4">
                <form action="" class="student-examination-form animation animated fadeInLeft">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="" class="form-label mt-2">D.O.B</label>
                                <input type="text" placeholder="Select D.O.B" name="dob" class="form-control">
                            </div>
                        </div>
        ...
        <div class="row student-examination-data-response"></div>
    </div>
</section>