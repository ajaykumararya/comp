    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="text-center animation animated fadeInUp" data-aos="fade-up" data-animation="fadeInUp"
                    ...
                    <div class="heading_s1 text-center">
                        <h2 class="main-heading center-heading"><i class="fa fa-list-alt"></i> ISO Certificate
                            Verification
                        </h2>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 mb-4 mt-4">
                <form action="" class="iso-form-verification animation animated fadeInLeft">
                    <div class="<?= themeCard('main', 'panel-primary') ?>">
                        <div class="<?= themeCard('body') ?>">
                            <div class="form-group">
                                <label for="" class="form-label mt-2">Certificate Number</label>
                                <input type="text" placeholder="Enter Certificate Number" name="certificate_no"
                                    class="form-control">
                            </div>
                        </div>
