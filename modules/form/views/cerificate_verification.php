            ...
            <div class="col-md-12">
                <div class="text-center animation animated fadeInUp" data-aos="fade-up" data-animation="fadeInUp"
                    ...
                    <div class="heading_s1 text-center">
                        <h2 class="main-heading center-heading"><i class="fa fa-file"></i>  <?=$this->ki_theme->get_form_title('certificate_verification_form_title','Certificate Verification')?></h2>
                    </div>
                </div>
            </div>
        </div>
