        ...
        <div class="col-md-12 mt-3 mb-3">
            <div class="card">
                <div class="card-header bg-dark">
                    <h3 class="card-title text-white"><i class="fa fa-eye"></i> <?= $student_data['student_name'] ?>
                        Details</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td rowspan="4" style="width:100px">
                                    <img src="{base_url}upload/<?= $student_data['image'] ?>"
                                        alt="<?= $student_data['student_name'] ?> Photo"
