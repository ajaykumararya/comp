            ...
            <div class="col-lg-6">
                <div class="card shadow-sm bg-transparent border-dark">
                    <div class="card-header bg-transparent border-0">
                        <h3 class="mb-0 card-title "><i class="far fa-clone pr-1 fs-2 text-dark"></i> &nbsp; Complete
                            Your Form
                        </h3>
                    </div>
                    <div class="card-body pt-0 p-0">
                        <h4 class="text-success" style="    border: 1px solid green;    border-left: 12px solid;    padding: 4px;    border-right: 12px solid;    text-align: center;    border-radius: 6px;">{course_name} - {duration} {duration_type}</h4>
                    </div>
                    <div class="card-footer">
                        <button
                            ...
                            type="submit"><span class="pulse-ring"></span> <i class="ki-duotone ki-save-2 fs-1"><span
                                    class="path1"></span><span class="path2"></span></i>&nbsp;Submit Your Data</button>
                    </div>
                </div>
            </div>
        </div>
