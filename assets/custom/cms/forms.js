document.addEventListener('DOMContentLoaded', function () {
    ...
    $(document).find('.form-setting').on('click', function () {
        // alert(2);
        ...
        $.AryaAjax({
            ...
            if(res.useDrawer !== undefined && res.useDrawer){
                const box = mydrawer(res.title);
                box.find('.card-body').html(res.html).css('padding',0);
            }
            else if(type == 'student_admission')
            {
