...
<body class="position-relative">
    ...
    <p class="position-absolute" style="bottom:6.2%;left:20%;">{issue_date}</p>


    <!-- <p class="position-absolute" style="top:17%;right:15%;font-size:12px">{enrollment_no}</p> -->
    <p class="position-absolute" style="top:33.2%;left:28%">{student_name}</p>
    <p class="position-absolute" style="top:35.2%;left:28%">{father_name}</p>
    <p class="position-absolute " style="top:37.5%;left:28%">{session}</p>
    <p class="position-absolute " style="top:33.2%;left:66.5%;width:200px">{roll_no}</p>
    <p class="position-absolute " style="top:35.2%;left:66.5%">{enrollment_no}</p>
    <p class="position-absolute text-capitlize" style="top:37.2%;left:66.5%">{duration} {duration_type}</p>
    <!-- <p class="position-absolute " style="top:39.6%;left:36.5%">{dob}</p> -->
    <div class="position-absolute" style="bottom:21.5%;left:69.2%;">
        <img src="upload/images/marksheet_{result_id}.png" style="width:100px;height:100px;" alt="">
    </div>
    ...
    <p class="position-absolute" style="bottom:24.5%;left:50%;font-size:15px;width:100px">{total}</p>
    <p class="position-absolute" style="bottom:16.35%;left:40.5%;font-size:15px"><?=numberToWords($obtain_total)?></p>
    <p class="position-absolute" style="bottom:22.6%;left:50%;font-size:15px;width:100px">{obtain_total}</p>
    <p class="position-absolute" style="bottom:20.35%;left:50%;font-size:15px">{percentage} %</p>
