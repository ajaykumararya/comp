...
<body class="position-relative">
    ...
    <div class="position-absolute" id="photo">
        <img src="upload/{image}" style="width:165px;height:195px;">
    </div>
    <!-- <p class="position-absolute" style="top:1%;left:80%">{createdOn}</p>
    <p class="position-absolute" style="top:1%;left:16%">{admit_card_id}</p> -->

    <p class="position-absolute" style="top:13.5%;left:82%;width:120px">{roll_no}</p>
    ...
    <p class="position-absolute" style="top:22.8%;left:25.5%">{dob}</p>
    <p class="position-absolute" style="top:24.9%;left:25.5%">{course_name}</p>
    <p class="position-absolute" style="top:31.8%;left:25.5%">{session}</p>
    ...
    ?>
    <div class="position-absolute" style="top:2.65%;left:84%">
        <img style="width:93px;" src="upload/images/admit_card_{admit_card_id}.png" alt="">
    </div>
</body>
