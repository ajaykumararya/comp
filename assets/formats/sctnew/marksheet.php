...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:33.5%;left:36%;">{student_name}</p>
    <p class="position-absolute" style="top:36.3%;left:36%;">{mother_name}</p>
    <p class="position-absolute " style="top:38.8%;left:36%">{father_name}</p>
    ...
    <p class="position-absolute text-capitlize" style="top:38.5%;left: 82.5%;width:110px;text-align:left"><?=numberToFullOrdinal($marksheet_duration)?> {duration_type}</p>
                ...
                foreach ($marks as $mark) {
                    ...
                    echo $this->parser->parse_string('
                                    <tr>
                                        ...
                                        <td class="lb fw" style="font-size:12.819px;width:95px">{mark_total}</td>
                                        <td class="lb fw" style="font-size:12.819px">{inword}</td>
                                    </tr>', $mark, true);
                }
                ?>
            </tbody>
    ...
    <p class="position-absolute " style="font-weight:300;top:74.3%;left:67%;font-size:18px;width:200px;line-height:1"><?= numberToWords($total) ?></p>
