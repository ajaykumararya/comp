...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:24.2%;left:61.6%">{roll_no}</p>
    <p class="position-absolute " style="top:24.2%;left:24.5%;width:130px">{enrollment_no}</p>
    ...
    <p class="position-absolute" style="top:26.5%;left:24.4%">{course_name}</p>
    <p class="position-absolute" style="top:29.1%;left:24.4%">{student_name}</p>
    <p class="position-absolute" style="top:31.6%;left:24.4%">{father_name}</p>
    <p class="position-absolute" style="top:34.1%;left:24.4%">{mother_name}</p>
    <p class="position-absolute" style="top:36.6%;left:24.4%">{dob}</p>
    <p class="position-absolute text-capitlize" style="top:36.6%;left:64%">{gender}</p>
    <!-- <p class="position-absolute" style="top:38.9%;left:24.4%">{center_name}</p> -->
    <?php
    $where = [
        'course_id' => $course_id,
    ...
    if ($get->num_rows()) {
        ...
        $subjects = $this->db->select('s.*,acs.date,acs.time')
                ...
                ->get();
        ?>
        <p class="position-absolute text-capitlize" style="top:38.9%;left:24.4%"><?= $row->centre_name ?></p>
        ...
        <div class="position-absolute " style="top:52%;left:6.5%;width:87%">
    ...
    ?>
    <div class="position-absolute" style="top:84.7%;left:5.3%">
        <img style="width:90px;" src="upload/images/admit_card_{admit_card_id}.png" alt="">
    </div>
</body>
