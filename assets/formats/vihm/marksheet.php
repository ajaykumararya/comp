...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:15.2%;left:22.5%;width:200px">{roll_no}</p>
    <p class="position-absolute" style="top:15.2%;left:74%;width:200px">{enrollment_no}</p>


    <!-- <p class="position-absolute" style="top:17%;right:15%;font-size:12px">{enrollment_no}</p> -->
    <p class="position-absolute" style="top:39.4%;left:35%">{student_name}</p>
    <!-- <p class="position-absolute" style="top:25.2%;left:22%">{dob}</p> -->
    <p class="position-absolute " style="top:42.6%;left:35%">{father_name}</p>
    <p class="position-absolute text-center" style="top:32%;left:10%;width:80%;font-size:2rem;color:red">{course_name}</p>
    ...
    <p class="position-absolute " style="top:42.6%;left:72%">{session}</p>
    ...
    <div class="position-absolute " style="top:47%;left:10%;width:80%">
    ...
    <p class="position-absolute" style="bottom:23.5%;left:20%;font-size:15px">{issue_date}</p>
