...
<body class="position-relative">
    ...
    <div class="position-absolute" id="photo">
        <img src="upload/{image}" style="width:85px;height:106px">
    </div>
    ...
    <p class="position-absolute" style="top:32%;left:29%">{student_name}</p>
    <p class="position-absolute" style="top:34.5%;left:29%">{father_name}</p>
    <p class="position-absolute" style="top:37%;left:20%">{course_name}</p>
    <p class="position-absolute text-capitlize" style="top:39.5%;left:20.4%">{gender}</p>
    <p class="position-absolute" style="top:39.5%;left:46%">{dob}</p>
    <p class="position-absolute" style="top:39.5%;left:79.4%">{session}</p>
    <p class="position-absolute" style="top:42%;left:63%;width:200px">{roll_no}</p>
    <p class="position-absolute" style="top:42%;left:20%;">{enrollment_no}</p>
    ...
    if ($get->num_rows()) {
        ...
        $subjects = $this->db->select('s.*,acs.date,acs.time')
                ...
                ->get();
        ?>
        <p class="position-absolute text-capitlize" style="top:46.8%;left:30%"><?= $row->centre_name ?></p>
        <p class="position-absolute" style="top:44.4%;left:24.4%"><?= $row->centre_code ?></p>
        <div class="position-absolute " style="top:53%;left:10%;width:80%">
    ...
    ?>
    <p class="position-absolute" style="bottom:2.9%;left:16%">{createdOn}</p>
    <div class="position-absolute" style="bottom:4.55%;left:43.2%">
        <img style="width:50px;" src="upload/images/admit_card_{admit_card_id}.png" alt="">
    </div>
</body>
