...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:29.4%;left:28%;width:255px">{student_name}</p>
    <p class="position-absolute" style="top:31.4%;left:28%;width:255px">{father_name}</p>
    <p class="position-absolute" style="top:33.2%;left:28%;width:255px">{mother_name}</p>

    <p class="position-absolute" style="top:2.6%;left:21%;width:120px">{serial_no}</p>
    <p class="position-absolute" style="top:36.6%;left:28%;width:120px">{roll_no}</p>
    <p class="position-absolute " style="top:35%;left:28%;width:120px">{enrollment_no}</p>
    <p class="position-absolute " style="top:38.8%;left:20%;width:500px;line-height:1;text-align:left">{course_name}</p>
    <?php
// $myduration = humnize_duration_with_ordinal($marksheet_duration,$duration_type);
    ...
    <p class="position-absolute" style="top:40.7%;left:25%;width:60%;line-height:1;text-align:left">{center_name}</p>
    ...
    <div class="position-absolute" style="top:31.5%;left:80%;">
        <img src="upload/{image}" style="width:60px;border:1px solid black" alt="">
    </div>
    <div class="position-absolute " style="top:46%;left:10%;width:80%">
    ...
    <p class="position-absolute" style="bottom:2.5%;left:13.5%;width:138px;text-align:left">{issue_date}</p>
