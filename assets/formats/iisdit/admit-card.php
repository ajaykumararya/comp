...
<body class="position-relative">
    ...
    <div class="position-absolute" id="photo">
        <img src="upload/{image}" style="width:100px;height:100px;border:1px solid black">
    </div>
    <!-- <p class="position-absolute" style="top:1%;left:80%">{createdOn}</p>
    <p class="position-absolute" style="top:1%;left:16%">{admit_card_id}</p> -->

    <p class="position-absolute" style="top:17.8%;left:82%">{enrollment_no}</p>
    <p class="position-absolute " style="top:17.8%;left:20.8%;width:130px">{roll_no}</p>
    ...
    <p class="position-absolute" style="top:20%;left:20.8%">{student_name}</p>
    <p class="position-absolute" style="top:22%;left:20.8%">{father_name}</p>
    <p class="position-absolute" style="top:24.1%;left:20.8%">{mother_name}</p>
    <p class="position-absolute" style="top:26.15%;left:20.8%">{course_name}</p>
    <p class="position-absolute" style="top:19.8%;left:82%">{dob}</p>
    ...
    if ($get->num_rows()) {
        ...
        $subjects = $this->db->select('s.*,acs.date,acs.time')
                ...
                ->get();
        ?>
        <p class="position-absolute text-capitlize" style="top:28.21%;left:20.8%"><?= $row->centre_name ?></p>
        <p class="position-absolute" style="top:22%;left:82%"><?= $row->session ?></p>
        <!-- <p class="position-absolute" style="top:40%;left:24.4%"><?= $row->centre_address ?></p> -->
        <div class="position-absolute " style="top:37%;left:6.5%;width:87%">
