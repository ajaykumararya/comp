...
<head>
    ...
    <title>{student_name} Registration Certificate</title>
    {basic_header_link}
    <style>
        body {
...
<?php
$this->ki_theme->generate_qr($student_id, 'registration_form', base_url('registration-form/' . $studentEncodeId))
    ?>
...
<body class="position-relative">
    ...
    <div class="position-absolute" style="top:34.2%;left:81.03%;">
        <img src="upload/{image}" style="width:62.5px;height:81px;" alt="">
    </div>
