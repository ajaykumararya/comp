...
<body class="position-relative">
    <img id="back-image" class="position-relative" src="{document_path}/marksheet-front.jpg">
    <div class="position-absolute" id="photo">
        <img src="upload/{image}" style="width:79px;height:103px">
    </div>



    <p class="position-absolute" style="top:6.6%;left:17%;width:200px">{serial_no}</p>
    <p class="position-absolute" style="top:6.6%;left:78.5%;width:150px">{roll_no}</p>
    ...
    <p class="position-absolute" style="top:32.1%;left:23%;width:200px">{student_name}</p>
    <p class="position-absolute " style="top:34%;left:23%;width:60%">{father_name}</p>
    <p class="position-absolute " style="top:36.2%;left:23%;width:60%">{mother_name}</p>
    ...
    <p class="position-absolute " style="top:38.4%;left:23%;width:63%">{course_name}</p>
    <p class="position-absolute " style="top:40.6%;left:23%;width:63%">{center_name}</p>

    <div class="position-absolute" style="z-index: 999;top: 89.5%;left: 23.1%;">
        <img src="upload/images/marksheet_{result_id}.png" style="width: 57.5px" alt="">
    </div>
    ...
    <p class="position-absolute" style="bottom:3.6%;left:14.7%;font-size:12px">{issue_date}</p>
    <!-- <p class="position-absolute" style="bottom:3.6%;left:15%;font-size:13px">New Delhi</p> -->
     
    <img class="position-relative" src="{document_path}/marksheet-back.jpg">
</body>
