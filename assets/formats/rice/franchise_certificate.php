...
<body class="position-relative">
    ...
    <div class="position-absolute" style="top:42.5%;left:10%;width:76%;text-align:center;text-transform:capitalize">{institute_name}</div>

    <div class="position-absolute" style="top:54.5%;left:27%;">{center_number}</div>
    <div class="position-absolute" style="top:50.5%;left:27%;">{city}, &nbsp;{state}</div>
    <div class="position-absolute" style="top:46.5%;left:27%;">{name}</div>
    
    <div class="position-absolute" style="top:58.8%;left: 27%">{certificate_issue_date}</div>
    <div class="position-absolute" style="top:62.8%;left:27%">{valid_upto}</div>
