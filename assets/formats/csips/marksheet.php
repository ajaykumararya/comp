...
<body class="position-relative">
    ...
    <div class="position-absolute" style="top:27.15%;left:76.1%;">
        <img src="upload/images/marksheet_{result_id}.png" style="width:132px" alt="">
    </div>
    
    <p class="position-absolute text-center " style="top:2.3%;left:12%">{serial_no}</p>
    <p class="position-absolute text-center " style="top:38.2%;left:80%;">{enrollment_no}</p>
    <p class="position-absolute text-center " style="top:2.3%;left:82%;">{roll_no}</p>
    <p class="position-absolute text-center " style="top:40.3%;left:80%;">{dob}</p>
    <p class="position-absolute text-center " style="top:42.4%;left:80%;text-transform:capitalize">{gender}</p>


    <!-- <p class="position-absolute" style="top:17%;right:15%;font-size:12px">{enrollment_no}</p> -->
    <p class="position-absolute" style="top:38.2%;left:39.5%">{student_name}</p>
    <p class="position-absolute " style="top:40.3%;left:39.5%">{father_name}</p>
    <p class="position-absolute " style="top:42.3%;left:39.5%">{mother_name}</p>
    <p class="position-absolute" style="top:44.45%;left:39.5%">{course_name}</p>
    <!-- <p class="position-absolute " style="top:31.1%;left:22%">{mother_name}</p> -->
    <p class="position-absolute " style="top: 46.6%;left:39.5%"><?=humnize_duration_with_ordinal($marksheet_duration,$duration_type)?></p>
    <!--<p class="position-absolute " style="top:32.9%;left:22%;line-height:1;width:460px">{center_full_address}</p>-->
    <p class="position-absolute " style="top:48.7%;left:39.5%">{center_name}</p>
    ...
    <div class="position-absolute " style="top:52.5%;left:7%;width:86%">
    ...
    <p class="position-absolute" style="top:80.6%;left:81%;">{grade}</p>
    <p class="position-absolute" style="top:80.6%;left:60%">{percentage} %</p>
    <p class="position-absolute" style="top:80.6%;left:29%;">{issue_date}</p>
