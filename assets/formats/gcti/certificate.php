...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:2%;left:79.5%;width:130px;text-align:center">{roll_no}</p>
    <p class="position-absolute" style="top:2%;left:20%;width:130px;text-align:center">{enrollment_no}</p>
